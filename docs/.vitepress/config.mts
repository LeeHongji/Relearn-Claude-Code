...
const enSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Tools and Permissions', link: '/claude-code/tools-and-permissions' },
      { text: 'Commands, UI, and Extensions', link: '/claude-code/commands-ui-extensions' },
      { text: 'Memory and Multi-Agent', link: '/claude-code/memory-and-multi-agent' },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Tools and Permission Tour', link: '/source-tours/tools-permission-tour' },
      { text: 'Context and Memory Tour', link: '/source-tours/context-memory-tour' },
...
const zhSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '命令、界面与扩展', link: '/zh/claude-code/commands-ui-extensions' },
      { text: '记忆与多智能体', link: '/zh/claude-code/memory-and-multi-agent' },
...
export default defineConfig({
  ...
  description: 'English-first, bilingual deep dive into Claude Code and AI agent engineering.',
