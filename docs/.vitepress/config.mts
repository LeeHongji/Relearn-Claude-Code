...
const enSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "MCP and External Tools",
        link: "/claude-code/mcp-and-external-tools",
      },
      {
        text: "Skills and Prompt Loading",
        link: "/claude-code/skills-and-prompt-loading",
      },
      {
        text: "Plugins and Extension Surfaces",
        link: "/claude-code/plugins-and-extension-surfaces",
      },
      {
        text: "Tasks and Orchestration",
        link: "/claude-code/tasks-and-orchestration",
      },
      { text: "Ink and Terminal UI", link: "/claude-code/ink-and-terminal-ui" },
      {
        text: "Settings and Remote Policy",
        link: "/claude-code/settings-and-remote-policy",
      },
      {
        text: "LSP and Editor Feedback",
...
const zhSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: "MCP 与外部工具",
        link: "/zh/claude-code/mcp-and-external-tools",
      },
      {
        text: "Skills 与提示词装载",
        link: "/zh/claude-code/skills-and-prompt-loading",
      },
      {
        text: "插件与扩展边界",
        link: "/zh/claude-code/plugins-and-extension-surfaces",
      },
      { text: "任务与编排", link: "/zh/claude-code/tasks-and-orchestration" },
      { text: "Ink 与终端渲染", link: "/zh/claude-code/ink-and-terminal-ui" },
      {
        text: "设置与远程策略",
        link: "/zh/claude-code/settings-and-remote-policy",
      },
      {
        text: "LSP 与编辑器反馈",
      ...
      {
        text: "溢出恢复与响应式压缩",
        link: "/zh/claude-code/overflow-recovery-and-reactive-compact",
      },
      {
        text: "命令、界面与扩展",
